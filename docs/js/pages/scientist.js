        ...
        openChatbotBtn.addEventListener('click', () => {
            if (typeof window.openChatbotModal === 'function') {
                ...
                if (typeof window.initializeChatbotUI === 'function') {
                    ...
                    // Simuler un clic sur le bouton "Scientifique" pour activer la persona
                    const chatbotModal = document.getElementById('chatbotModal');
                    if (chatbotModal) {
                        const scientistPersonaButton = chatbotModal.querySelector('[data-persona="scientifique"]');
                        if (scientistPersonaButton && !scientistPersonaButton.classList.contains('active-persona')) {
                            scientistPersonaButton.click(); // Simule le clic
                        }
                    } else {
